...
Чтобы влить изминения из одной ветки в другую нужно совершить команду:

### Конфликты слияний

Если при слиянии в двух версиях файла одна и таже строка напечатана по разному произойдет конфликт двух веток