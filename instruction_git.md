...
Удалённые репозитории это  очень полезный инструмент для работы в команде. 
...
** Слияние текущих ветвей с локальной версией.

Выполнить выборку, а затем слияние и фиксацию  в текущую локальную ветвь командой:
